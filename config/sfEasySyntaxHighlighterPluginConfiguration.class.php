...
/**
 * sfEasySyntaxHighlighterPlugin configuration.
 *
 * @package     sfEasySyntaxHighlighterPlugin
 * @subpackage  config
 * @author      Your name here
 * @version     SVN: $Id$
 */
class sfEasySyntaxHighlighterPluginConfiguration extends sfPluginConfiguration
{
